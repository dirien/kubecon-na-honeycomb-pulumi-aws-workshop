...
:image[Studio Signin]{src="/static/images/aws-event/sign-in.png" width=450}
...
:image[Enter Code]{src="/static/images/aws-event/enter-access-code.png" width=450}

4. Read and agree to the *Terms and Conditions* by selecting **I agree with the terms and conditions** and choose **Join Event**.

:image[Terms and Conditions]{src="/static/images/aws-event/workshop-studio-tc.png" width=450}

You will be taken to the workshop instructions. 

5. Access the management console of your AWS account for the event by clicking the link in the sidebar. This will make sure you logged in to your event's AWS account.
